  ...
  try {
    ...
    if (user) {
      ...
      const mailData = {
        ...
        <p>Verify your email address to complete the signup and login into your <strong>HD design Fashion Hub</strong> account.</p>
  ...
  try {
    ...
    if (!user) {
      ...
      const body = {
        ...
        <p>A request has been received to change the password for your <strong>HD design Fashion Hub</strong> account </p>
